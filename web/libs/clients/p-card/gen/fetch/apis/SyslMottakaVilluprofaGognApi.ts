 ...
 * 
 */
export class SyslMottakaVilluprofaGognApi extends runtime.BaseAPI {
    ...
    async syslMottakaVilluprofaGognPostRaw(requestParameters: SyslMottakaVilluprofaGognPostRequest): Promise<runtime.ApiResponse<Skilabod>> {
        if (requestParameters.payload === null || requestParameters.payload === undefined) {
            throw new runtime.RequiredError('payload','Required parameter requestParameters.payload was null or undefined when calling syslMottakaVilluprofaGognPost.');
        }
