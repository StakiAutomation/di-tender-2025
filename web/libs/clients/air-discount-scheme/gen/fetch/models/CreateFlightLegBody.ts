 ...
 * 
 * @export
 * @interface CreateFlightLegBody
 */
export interface CreateFlightLegBody {
    /**
     * 
     * @type {string}
     * @memberof CreateFlightLegBody
     */
    origin: string;
    /**
     * 
     ...
     * @memberof CreateFlightLegBody
     */
    cooperation: CreateFlightLegBodyCooperationEnum;
}

export function CreateFlightLegBodyFromJSON(json: any): CreateFlightLegBody {
    return CreateFlightLegBodyFromJSONTyped(json, false);
}

export function CreateFlightLegBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateFlightLegBody {
...
export function CreateFlightLegBodyToJSON(value?: CreateFlightLegBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum CreateFlightLegBodyCooperationEnum {
