...
import {
    CreateFlightLegBody,
    CreateFlightLegBodyFromJSON,
    CreateFlightLegBodyFromJSONTyped,
    CreateFlightLegBodyToJSON,
} from './';
...
export interface CreateFlightBody {
     ...
     * 
     * @type {Date}
     * @memberof CreateFlightBody
     */
    bookingDate: Date;
    /**
     * 
     * @type {Array<CreateFlightLegBody>}
     * @memberof CreateFlightBody
     */
    flightLegs: Array<CreateFlightLegBody>;
}

export function CreateFlightBodyFromJSON(json: any): CreateFlightBody {
    return CreateFlightBodyFromJSONTyped(json, false);
}

export function CreateFlightBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateFlightBody {
    ...
    return {
        ...
        'flightLegs': ((json['flightLegs'] as Array<any>).map(CreateFlightLegBodyFromJSON)),
    };
}

export function CreateFlightBodyToJSON(value?: CreateFlightBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'flightLegs': ((value.flightLegs as Array<any>).map(CreateFlightLegBodyToJSON)),
    };
}
