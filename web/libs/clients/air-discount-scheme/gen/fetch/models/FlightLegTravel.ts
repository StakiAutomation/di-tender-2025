 ...
 * 
 * @export
 * @interface FlightLegTravel
 */
export interface FlightLegTravel {
    /**
     * 
     * @type {string}
     * @memberof FlightLegTravel
     */
    from?: string;
    /**
     * 
...
export function FlightLegTravelFromJSON(json: any): FlightLegTravel {
    return FlightLegTravelFromJSONTyped(json, false);
}

export function FlightLegTravelFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlightLegTravel {
...
export function FlightLegTravelToJSON(value?: FlightLegTravel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
