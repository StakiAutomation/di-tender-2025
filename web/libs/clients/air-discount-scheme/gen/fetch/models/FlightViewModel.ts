...
import {
    FlightLegViewModel,
    FlightLegViewModelFromJSON,
    FlightLegViewModelFromJSONTyped,
    FlightLegViewModelToJSON,
} from './';
...
export interface FlightViewModel {
    ...
    /**
     * 
     * @type {Array<FlightLegViewModel>}
     * @memberof FlightViewModel
     */
    flightLegs: Array<FlightLegViewModel>;
}

export function FlightViewModelFromJSON(json: any): FlightViewModel {
    return FlightViewModelFromJSONTyped(json, false);
}

export function FlightViewModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlightViewModel {
    ...
    return {
        ...
        'flightLegs': ((json['flightLegs'] as Array<any>).map(FlightLegViewModelFromJSON)),
    };
}

export function FlightViewModelToJSON(value?: FlightViewModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'flightLegs': ((value.flightLegs as Array<any>).map(FlightLegViewModelToJSON)),
    };
}
