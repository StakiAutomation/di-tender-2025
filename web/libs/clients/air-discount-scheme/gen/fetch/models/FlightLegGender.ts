...
export function FlightLegGenderFromJSON(json: any): FlightLegGender {
    return FlightLegGenderFromJSONTyped(json, false);
}

export function FlightLegGenderFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlightLegGender {
    return json as FlightLegGender;
}

export function FlightLegGenderToJSON(value?: FlightLegGender | null): any {
    return value as any;
}
