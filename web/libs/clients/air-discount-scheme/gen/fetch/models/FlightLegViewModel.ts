 ...
 * 
 * @export
 * @interface FlightLegViewModel
 */
export interface FlightLegViewModel {
    /**
     * 
     * @type {string}
     * @memberof FlightLegViewModel
     */
    id: string;
    /**
     * 
...
export function FlightLegViewModelFromJSON(json: any): FlightLegViewModel {
    return FlightLegViewModelFromJSONTyped(json, false);
}

export function FlightLegViewModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlightLegViewModel {
...
export function FlightLegViewModelToJSON(value?: FlightLegViewModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
