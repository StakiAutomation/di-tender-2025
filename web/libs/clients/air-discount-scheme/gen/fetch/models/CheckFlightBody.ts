...
import {
    CheckFlightLegBody,
    CheckFlightLegBodyFromJSON,
    CheckFlightLegBodyFromJSONTyped,
    CheckFlightLegBodyToJSON,
} from './';

/**
 * 
 * @export
 * @interface CheckFlightBody
 */
export interface CheckFlightBody {
    /**
     * 
     * @type {Array<CheckFlightLegBody>}
     * @memberof CheckFlightBody
     */
    flightLegs: Array<CheckFlightLegBody>;
}

export function CheckFlightBodyFromJSON(json: any): CheckFlightBody {
    return CheckFlightBodyFromJSONTyped(json, false);
}

export function CheckFlightBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CheckFlightBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'flightLegs': ((json['flightLegs'] as Array<any>).map(CheckFlightLegBodyFromJSON)),
    };
}

export function CheckFlightBodyToJSON(value?: CheckFlightBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'flightLegs': ((value.flightLegs as Array<any>).map(CheckFlightLegBodyToJSON)),
    };
}
