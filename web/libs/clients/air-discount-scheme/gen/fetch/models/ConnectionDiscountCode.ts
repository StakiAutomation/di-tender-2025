 ...
 * 
 * @export
 * @interface ConnectionDiscountCode
 */
export interface ConnectionDiscountCode {
    /**
     * 
     * @type {string}
     * @memberof ConnectionDiscountCode
     */
    code: string;
    /**
     * 
...
export function ConnectionDiscountCodeFromJSON(json: any): ConnectionDiscountCode {
    return ConnectionDiscountCodeFromJSONTyped(json, false);
}

export function ConnectionDiscountCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionDiscountCode {
    ...
    return {
        ...
        'flightDesc': json['flightDesc'],
        'validUntil': json['validUntil'],
    };
}

export function ConnectionDiscountCodeToJSON(value?: ConnectionDiscountCode | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
