 ...
 * 
 * @export
 * @interface FlightLegPeriod
 */
export interface FlightLegPeriod {
    /**
     * 
     * @type {Date}
     * @memberof FlightLegPeriod
     */
    from: Date;
    /**
     * 
...
export function FlightLegPeriodFromJSON(json: any): FlightLegPeriod {
    return FlightLegPeriodFromJSONTyped(json, false);
}

export function FlightLegPeriodFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlightLegPeriod {
...
export function FlightLegPeriodToJSON(value?: FlightLegPeriod | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
