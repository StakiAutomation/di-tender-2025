 ...
 * 
 * @export
 * @interface CheckFlightLegBody
 */
export interface CheckFlightLegBody {
    /**
     * 
     * @type {string}
     * @memberof CheckFlightLegBody
     */
    origin: string;
    /**
     * 
...
export function CheckFlightLegBodyFromJSON(json: any): CheckFlightLegBody {
    return CheckFlightLegBodyFromJSONTyped(json, false);
}

export function CheckFlightLegBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CheckFlightLegBody {
...
export function CheckFlightLegBodyToJSON(value?: CheckFlightLegBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
