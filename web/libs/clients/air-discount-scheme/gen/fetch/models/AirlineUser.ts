 ...
 * 
 * @export
 * @interface AirlineUser
 */
export interface AirlineUser {
    /**
     * 
     * @type {string}
     * @memberof AirlineUser
     */
    firstName: string;
    /**
     * 
...
export function AirlineUserFromJSON(json: any): AirlineUser {
    return AirlineUserFromJSONTyped(json, false);
}

export function AirlineUserFromJSONTyped(json: any, ignoreDiscriminator: boolean): AirlineUser {
...
export function AirlineUserToJSON(value?: AirlineUser | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum AirlineUserGenderEnum {
    kk = 'kk',
    kvk = 'kvk',
    x = 'x',
    manneskja = 'manneskja'
