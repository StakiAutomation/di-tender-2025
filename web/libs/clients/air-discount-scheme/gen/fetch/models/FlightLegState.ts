 ...
 * @enum {string}
 */
export enum FlightLegState {
    AWAITING_DEBIT = 'AWAITING_DEBIT',
    SENT_DEBIT = 'SENT_DEBIT',
    AWAITING_CREDIT = 'AWAITING_CREDIT',
    SENT_CREDIT = 'SENT_CREDIT',
    CANCELLED = 'CANCELLED'
}

export function FlightLegStateFromJSON(json: any): FlightLegState {
    return FlightLegStateFromJSONTyped(json, false);
}

export function FlightLegStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlightLegState {
    return json as FlightLegState;
}

export function FlightLegStateToJSON(value?: FlightLegState | null): any {
    return value as any;
}
