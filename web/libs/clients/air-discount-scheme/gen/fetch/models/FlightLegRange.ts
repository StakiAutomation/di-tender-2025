 ...
 * 
 * @export
 * @interface FlightLegRange
 */
export interface FlightLegRange {
    /**
     * 
     * @type {number}
     * @memberof FlightLegRange
     */
    from: number;
    /**
     * 
...
export function FlightLegRangeFromJSON(json: any): FlightLegRange {
    return FlightLegRangeFromJSONTyped(json, false);
}

export function FlightLegRangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlightLegRange {
...
export function FlightLegRangeToJSON(value?: FlightLegRange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
