...
export function ConfirmInvoiceBodyFromJSON(json: any): ConfirmInvoiceBody {
    return ConfirmInvoiceBodyFromJSONTyped(json, false);
}

export function ConfirmInvoiceBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfirmInvoiceBody {
...
export function ConfirmInvoiceBodyToJSON(value?: ConfirmInvoiceBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
