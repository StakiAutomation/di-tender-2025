 ...
 * 
 */
export class SyslMottakaGognApi extends runtime.BaseAPI {
    ...
    async syslMottakaGognPostRaw(requestParameters: SyslMottakaGognPostRequest): Promise<runtime.ApiResponse<Skilabod>> {
        if (requestParameters.payload === null || requestParameters.payload === undefined) {
            throw new runtime.RequiredError('payload','Required parameter requestParameters.payload was null or undefined when calling syslMottakaGognPost.');
        }
