...
export interface SkraSveinsbrefModel {
     ...
     * @memberof SkraSveinsbrefModel
     */
    profstadur?: string | null;
    /**
     * 
     * @type {string}
     * @memberof SkraSveinsbrefModel
     */
    dagSveinsprof?: string | null;
    /**
     * 
     * @type {string}
     * @memberof SkraSveinsbrefModel
     */
    burtfaraskyrteiniFra?: string | null;
    /**
     * 
     * @type {string}
     * @memberof SkraSveinsbrefModel
     */
    dagsBurtfaraskyrteini?: string | null;
    /**
     * 
     * @type {string}
     * @memberof SkraSveinsbrefModel
     */
    dagsAfhendingarSveinsbref?: string | null;
    /**
     * 
     * @type {number}
     * @memberof SkraSveinsbrefModel
...
export function SkraSveinsbrefModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkraSveinsbrefModel {
    ...
    return {
        ...
        'stadidFallid': !exists(json, 'stadidFallid') ? undefined : json['stadidFallid'],
    };
}
