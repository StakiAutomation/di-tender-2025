...
export function CreateHnippNotificationDtoFromJSON(json: any): CreateHnippNotificationDto {
    return CreateHnippNotificationDtoFromJSONTyped(json, false);
}

export function CreateHnippNotificationDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateHnippNotificationDto {
    ...
    return {
        ...
        'onBehalfOf': !exists(json, 'onBehalfOf') ? undefined : HnippNotificationOriginalRecipientDtoFromJSON(json['onBehalfOf']),
        'templateId': json['templateId'],
        'args': ((json['args'] as Array<any>).map(ArgumentDtoFromJSON)),
    };
}

export function CreateHnippNotificationDtoToJSON(value?: CreateHnippNotificationDto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
