...
export type IsEmployerValidQueryVariables = Exact<{
  input: GetIsEmployerValidInput
}>

export type IsEmployerValidQuery = {
  __typename?: 'Query'
...
export type SearchCompaniesQueryResult = Apollo.QueryResult<
  ...
  SearchCompaniesQueryVariables
>
export const IsEmployerValidDocument = gql`
...
/**
 * __useIsEmployerValidQuery__
 *
 * To run a query within a React component, call `useIsEmployerValidQuery` and pass it any options that fit your needs.
 * When your component renders, `useIsEmployerValidQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useIsEmployerValidQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useIsEmployerValidQuery(
  baseOptions: Apollo.QueryHookOptions<
    IsEmployerValidQuery,
    IsEmployerValidQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<IsEmployerValidQuery, IsEmployerValidQueryVariables>(
    IsEmployerValidDocument,
    options,
  )
}
export function useIsEmployerValidLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    IsEmployerValidQuery,
    IsEmployerValidQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    IsEmployerValidQuery,
    IsEmployerValidQueryVariables
  >(IsEmployerValidDocument, options)
}
export type IsEmployerValidQueryHookResult = ReturnType<
  typeof useIsEmployerValidQuery
>
export type IsEmployerValidLazyQueryHookResult = ReturnType<
  typeof useIsEmployerValidLazyQuery
>
export type IsEmployerValidQueryResult = Apollo.QueryResult<
  IsEmployerValidQuery,
  IsEmployerValidQueryVariables
>
