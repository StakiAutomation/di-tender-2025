...
export type FriggOptionsQueryVariables = Exact<{
  type: EducationFriggOptionsListInput
}>

export type FriggOptionsQuery = {
  __typename?: 'Query'
  friggOptions?: Array<{
    __typename?: 'EducationFriggKeyOptionModel'
    type: string
...
export type FriggSchoolsByMunicipalityQueryVariables = Exact<{
  [key: string]: never
}>

export type FriggSchoolsByMunicipalityQuery = {
  __typename?: 'Query'
