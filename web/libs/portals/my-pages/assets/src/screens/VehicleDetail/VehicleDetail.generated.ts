...
export type GetUsersVehiclesDetailQueryVariables = Types.Exact<{
  input: Types.GetVehicleDetailInput
}>

export type GetUsersVehiclesDetailQuery = {
  __typename?: 'Query'
  vehiclesDetail?: {
...
export const GetUsersVehiclesDetailDocument = gql`
...
/**
 * __useGetUsersVehiclesDetailQuery__
 *
 * To run a query within a React component, call `useGetUsersVehiclesDetailQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUsersVehiclesDetailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useGetUsersVehiclesDetailQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetUsersVehiclesDetailQuery,
    GetUsersVehiclesDetailQueryVariables
  >,
) {
  ...
  return Apollo.useQuery<
    GetUsersVehiclesDetailQuery,
    GetUsersVehiclesDetailQueryVariables
  >(GetUsersVehiclesDetailDocument, options)
}
export function useGetUsersVehiclesDetailLazyQuery(
...
export type GetUsersVehiclesDetailQueryHookResult = ReturnType<
  typeof useGetUsersVehiclesDetailQuery
>
export type GetUsersVehiclesDetailLazyQueryHookResult = ReturnType<
  typeof useGetUsersVehiclesDetailLazyQuery
>
export type GetUsersVehiclesDetailQueryResult = Apollo.QueryResult<
  GetUsersVehiclesDetailQuery,
  GetUsersVehiclesDetailQueryVariables
>
